#+title:     Web Pentesting Checklist

/Taken from https://github.com/harshinsecurity/web-pentesting-checklist/blob/main/README.md/
...
- [ ] Find leaked ids, emails ([[https://github.com/davidtavarez/pwndb][pwndb]])
- [ ] Identify WAF
...
- [ ] Shodan
- [ ] Google dorking
- [ ] Check waybackurls ([[https://github.com/lc/gau][gau]] and [[https://github.com/tomnomnom/waybackurls][waybackurls]])

** Network tests [0/5]
- [ ] Check ICMP packets allowed
- [ ] Check DMARC policies ([[https://github.com/BishopFox/spoofcheck][spoofcheck]])
- [ ] Look services on other ports than 80 and 443
- [ ] Check UDP ports ([[https://github.com/CiscoCXSecurity/udp-proto-scanner][udp-proto-scanner]] or nmap)
- [ ] Test SSL ([[https://github.com/drwetter/testssl.sh][testssl]])
...
- [ ] Check for password wordlist ([[https://github.com/digininja/CeWL][cewl]] and [[https://github.com/GainSec/GoldenNuggets-1][burp-goldenNuggets]])
...
- [ ] File upload: Unsafe File upload, No Antivirus, No Size Limit, File extension, Filter Bypass, [[https://github.com/portswigger/upload-scanner][burp]]
...
- [ ] [[https://github.com/exiftool/exiftool][Metadata]] of all downloadable files
...
** Logic handling [0/22]
 ...
 - [ ] CORS ([[https://github.com/s0md3v/Corsy][corsy]])
